import { require_react_dom } from './chunk-RVSLBP3T.js'
import { require_react } from './chunk-ST3U5LCA.js'
import { __commonJS, __toESM } from './chunk-DFKQJ226.js'
    ...
    if (true) {
      ;(function () {
        ...
        var useState = React3.useState,
          useEffect2 = React3.useEffect,
          useLayoutEffect2 = React3.useLayoutEffect,
          useDebugValue2 = React3.useDebugValue
        ...
        var useSyncExternalStore$2 =
          React3.useSyncExternalStore !== void 0
            ? React3.useSyncExternalStore
            : shim
...
function connect(
  ...
  const wrapWithConnect = (WrappedComponent) => {
    ...
    function ConnectFunction(props) {
      const [propsContext, reactReduxForwardedRef, wrapperProps] = (0,
      import_react5.useMemo)(() => {
        const { reactReduxForwardedRef: reactReduxForwardedRef2 } = props,
      ...
      const ContextToUse = (0, import_react5.useMemo)(() => {
        return propsContext &&
          ...
          (0, import_react_is.isContextConsumer)(
            import_react5.default.createElement(propsContext.Consumer, null)
          )
          ? propsContext
          : Context
      ...
      const [subscription, notifyNestedSubs] = (0,
      import_react5.useMemo)(() => {
...
`
    ...
    if (forwardRef) {
      const _forwarded = import_react5.default.forwardRef(
...
function Provider({ store, context, children, serverState }) {
  ...
  const previousState = (0, import_react6.useMemo)(
    () => store.getState(),
    [store]
  )
  useIsomorphicLayoutEffect(() => {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6GLXFWPD.js.map
