...
function useFieldArray(props) {
  ...
  const prepend$1 = (value, options) => {
    ...
    const updatedFieldArrayValues = prepend(
      control._getFieldArray(name),
      prependValue
    )
  ...
  return {
    ...
    prepend: import_react.default.useCallback(prepend$1, [
      updateValues,
      name,
      control,
    ]),
    append: import_react.default.useCallback(append$1, [
      updateValues,
      name,
      control,
    ]),
...
function createFormControl(props = {}, flushRootRender) {
  ...
  const _updateIsValidating = (value) =>
  ...
  const onChange = async (event) => {
    ...
    if (field) {
      ...
      if (_options.resolver) {
        ...
        isFieldValueUpdated =
          isNaN(fieldValue) || fieldValue === get(_formValues, name, fieldValue)
  ...
  if (!_formControl.current) {
    _formControl.current = {
      ...createFormControl(props, () =>
        updateFormState((formState2) => ({ ...formState2 }))
      ),
      formState,
    }
  }
