...
import {
  ...
  prepareAutoBatched,
  t,
} from './chunk-5AXYUQWH.js'
import { require_react } from './chunk-ST3U5LCA.js'
import { __toESM } from './chunk-DFKQJ226.js'
        ...
        switch (_q.label) {
          case 0:
            ;(signal = api.signal),
              ...
              (forced = api.forced),
              (type = api.type)
            ;(_a2 = typeof arg == 'string' ? { url: arg } : arg),
              (url = _a2.url),
              (_j2 = _a2.headers),
              (headers =
                _j2 === void 0 ? new Headers(baseFetchOptions.headers) : _j2),
              (_k2 = _a2.params),
              (params = _k2 === void 0 ? void 0 : _k2),
              (_l2 = _a2.responseHandler),
              (responseHandler = _l2 === void 0 ? 'json' : _l2),
              (_m2 = _a2.validateStatus),
              (validateStatus =
                _m2 === void 0
                  ? globalValidateStatus != null
                    ? globalValidateStatus
                    : defaultValidateStatus
                  : _m2),
              (_o = _a2.timeout),
              (timeout = _o === void 0 ? defaultTimeout : _o),
              (rest = __objRest(_a2, [
                'url',
                'headers',
                'params',
            ...
            config = __spreadValues(
              __spreadProps(__spreadValues({}, baseFetchOptions), {
                signal,
              }),
              rest
            )
      ...
      return __generator(this, function (_j) {
        switch (_j.label) {
          ...
          case 4:
            ...
            if (
              e_3 instanceof HandledError &&
              !options.retryCondition(e_3.value.error, args, {
                attempt: retry2,
                baseQueryApi: api,
                extraOptions,
              })
...
function buildInitiate(_j) {
  ...
  function getRunningOperationPromises() {
    if (typeof process !== 'undefined' && true) {
      ...
      return __spreadArray(
        __spreadArray([], extract(runningQueries)),
        extract(runningMutations)
      ).filter(isNotNullish)
    }
  }
  function getRunningQueryThunk(endpointName, queryArgs) {
    return function (dispatch) {
      ...
      return (_a = runningQueries.get(dispatch)) == null
        ? void 0
        : _a[queryCacheKey]
    }
  }
  function getRunningMutationThunk(_endpointName, fixedCacheKeyOrRequestId) {
    return function (dispatch) {
      var _a
      return (_a = runningMutations.get(dispatch)) == null
        ? void 0
        : _a[fixedCacheKeyOrRequestId]
    }
  }
  function getRunningQueriesThunk() {
    return function (dispatch) {
      return Object.values(runningQueries.get(dispatch) || {}).filter(
        isNotNullish
      )
    }
  }
  function getRunningMutationsThunk() {
    return function (dispatch) {
      return Object.values(runningMutations.get(dispatch) || {}).filter(
        isNotNullish
      )
    }
  }
  function middlewareWarning(dispatch) {
    if (true) {
      ...
      if (typeof registered !== 'boolean') {
        throw new Error(
          'Warning: Middleware for RTK-Query API at reducerPath "' +
            api.reducerPath +
  ...
  function buildInitiateQuery(endpointName, endpointDefinition) {
    var queryAction = function (arg, _j2) {
      var _k2 = _j2 === void 0 ? {} : _j2,
        _l = _k2.subscribe,
        subscribe = _l === void 0 ? true : _l,
        forceRefetch = _k2.forceRefetch,
        subscriptionOptions = _k2.subscriptionOptions,
      ...
      return function (dispatch, getState) {
        ...
        var thunk = queryThunk(
          ...
          (_j3[forceQueryFnSymbol] = forceQueryFn),
          _j3)
        )
        ...
        var runningQuery =
          (_a = runningQueries.get(dispatch)) == null
            ? void 0
            : _a[queryCacheKey]
        var selectFromState = function () {
          return selector(getState())
        }
        var statePromise = Object.assign(
          forceQueryFn
  ...
  function buildInitiateMutation(endpointName) {
    return function (arg, _j2) {
      var _k2 = _j2 === void 0 ? {} : _j2,
        ...
        fixedCacheKey = _k2.fixedCacheKey
      return function (dispatch, getState) {
        ...
        var returnValuePromise = thunkResult
          .unwrap()
          .then(function (data) {
            return { data }
          })
...
function buildThunks(_j) {
    ...
    return function (dispatch, getState) {
      ...
      if ('data' in currentState) {
        if (t(currentState.data)) {
          var _l = cn(currentState.data, updateRecipe),
            patches = _l[1],
            inversePatches = _l[2]
  ...
  var upsertQueryData = function (endpointName, args, value) {
    return function (dispatch) {
      var _j2
      return dispatch(
        api.endpoints[endpointName].initiate(
          args,
          ((_j2 = {
            subscribe: false,
            forceRefetch: true,
  ...
  var executeEndpoint = function (_0, _1) {
    return __async(_this, [_0, _1], function (arg, _j2) {
      var endpointDefinition,
        ...
        e_4
      var _p, _q
      var signal = _j2.signal,
        abort = _j2.abort,
        rejectWithValue = _j2.rejectWithValue,
        fulfillWithValue = _j2.fulfillWithValue,
        dispatch = _j2.dispatch,
        getState = _j2.getState,
        extra = _j2.extra
        ...
        switch (_r.label) {
          ...
          case 10:
            return [
              ...
              _o.apply(void 0, [
                _r.sent(),
                ((_q = { baseQueryMeta: catchedError.meta }),
                (_q[SHOULD_AUTOBATCH] = true),
                _q),
              ]),
            ]
          case 11:
  ...
  function isForcedQuery(arg, state) {
    var _a, _b, _c, _d
    var requestState =
      (_b = (_a = state[reducerPath]) == null ? void 0 : _a.queries) == null
        ? void 0
        : _b[arg.queryCacheKey]
    var baseFetchOnMountOrArgChange =
      (_c = state[reducerPath]) == null
        ? void 0
        : _c.config.refetchOnMountOrArgChange
    var fulfilledVal =
      requestState == null ? void 0 : requestState.fulfilledTimeStamp
    var refetchVal =
      (_d = arg.forceRefetch) != null
        ? _d
  ...
  var queryThunk = createAsyncThunk(
    ...
    executeEndpoint,
    {
      getPendingMeta: function () {
        var _j2
        return (
          (_j2 = { startedTimeStamp: Date.now() }),
          (_j2[SHOULD_AUTOBATCH] = true),
          _j2
        )
      },
      condition: function (queryThunkArgs, _j2) {
        ...
        var requestState =
          (_b = (_a = state[reducerPath]) == null ? void 0 : _a.queries) == null
            ? void 0
            : _b[queryThunkArgs.queryCacheKey]
        var fulfilledVal =
          requestState == null ? void 0 : requestState.fulfilledTimeStamp
        var currentArg = queryThunkArgs.originalArgs
        var previousArg =
          requestState == null ? void 0 : requestState.originalArgs
        var endpointDefinition =
        ...
        if (
          (requestState == null ? void 0 : requestState.status) === 'pending'
        ) {
          return false
        }
  ...
  var mutationThunk = createAsyncThunk(
  ...
  function matchesEndpoint(endpointName) {
    return function (action) {
      ...
      return (
        ((_b =
          (_a = action == null ? void 0 : action.meta) == null
            ? void 0
            : _a.arg) == null
          ? void 0
          : _b.endpointName) === endpointName
      )
    }
  }
...
function getMutationCacheKey(id) {
  var _a
  return (_a = 'arg' in id ? id.arg.fixedCacheKey : id.fixedCacheKey) != null
    ? _a
    : id.requestId
}
...
function buildSlice(_j) {
  ...
  var querySlice = createSlice({
    ...
    reducers: {
      ...
      queryResultPatched: function (draft, _j2) {
        var _k2 = _j2.payload,
          queryCacheKey = _k2.queryCacheKey,
          patches = _k2.patches
    ...
    extraReducers: function (builder) {
      builder
        .addCase(queryThunk.pending, function (draft, _j2) {
          var meta = _j2.meta,
            arg = _j2.meta.arg
          var _a, _b
          var upserting = isUpsertQuery(arg)
          if (arg.subscribe || upserting) {
            ;(_b = draft[(_a = arg.queryCacheKey)]) != null
              ? _b
              : (draft[_a] = {
            ...
            function (substate) {
              ...
              if (merge) {
                if (substate.data !== void 0) {
                  ...
                  var newData = immer_esm_default(
                    substate.data,
                    function (draftSubstateData) {
                ...
                substate.data = (
                  (_a = definitions[meta.arg.endpointName].structuralSharing) !=
                  null
                    ? _a
                    : true
                )
        ...
        .addCase(queryThunk.rejected, function (draft, _j2) {
          var _k2 = _j2.meta,
            condition = _k2.condition,
            arg = _k2.arg,
            requestId = _k2.requestId,
            error = _j2.error,
            payload = _j2.payload
          updateQuerySubstateIfExists(
            draft,
        ...
        .addMatcher(hasRehydrationInfo, function (draft, action) {
          ...
          for (
            var _j2 = 0, _k2 = Object.entries(queries);
            _j2 < _k2.length;
            _j2++
          ) {
            var _l = _k2[_j2],
              ...
              entry = _l[1]
            if (
              (entry == null ? void 0 : entry.status) ===
                QueryStatus.fulfilled ||
              (entry == null ? void 0 : entry.status) === QueryStatus.rejected
            ) {
              draft[key] = entry
            }
          }
  ...
  var mutationSlice = createSlice({
    ...
    extraReducers: function (builder) {
      builder
        .addCase(mutationThunk.pending, function (draft, _j2) {
          var meta = _j2.meta,
            _k2 = _j2.meta,
            requestId = _k2.requestId,
            arg = _k2.arg,
            startedTimeStamp = _k2.startedTimeStamp
          if (!arg.track) return
        ...
        .addMatcher(hasRehydrationInfo, function (draft, action) {
          ...
          for (
            var _j2 = 0, _k2 = Object.entries(mutations);
            _j2 < _k2.length;
            _j2++
          ) {
            var _l = _k2[_j2],
  ...
  var invalidationSlice = createSlice({
    ...
    extraReducers: function (builder) {
      builder
        .addCase(querySlice.actions.removeQueryResult, function (draft, _j2) {
          var queryCacheKey = _j2.payload.queryCacheKey
          for (var _k2 = 0, _l = Object.values(draft); _k2 < _l.length; _k2++) {
            var tagTypeSubscriptions = _l[_k2]
            for (
              var _m = 0, _o = Object.values(tagTypeSubscriptions);
              _m < _o.length;
              _m++
            ) {
        ...
        .addMatcher(hasRehydrationInfo, function (draft, action) {
          ...
          for (
            var _j2 = 0, _k2 = Object.entries(provided);
            _j2 < _k2.length;
            _j2++
          ) {
            var _l = _k2[_j2],
              ...
              incomingTags = _l[1]
            for (
              var _m = 0, _o = Object.entries(incomingTags);
              _m < _o.length;
              _m++
            ) {
              var _p = _o[_m],
                id = _p[0],
                cacheKeys = _p[1]
              var subscribedQueries =
                (_d = (_b =
                  (_a = draft[type]) != null ? _a : (draft[type] = {}))[
                  (_c = id || '__internal_without_id')
                ]) != null
                  ? _d
                  : (_b[_c] = [])
              for (
                var _q = 0, cacheKeys_1 = cacheKeys;
                _q < cacheKeys_1.length;
                _q++
              ) {
        ...
        .addMatcher(
          ...
          function (draft, action) {
            var _a, _b, _c, _d
            var providedTags = calculateProvidedByThunk(
              action,
              'providesTags',
              definitions,
              assertTagType
            ...
            for (
              var _j2 = 0, _k2 = Object.values(draft);
              _j2 < _k2.length;
              _j2++
            ) {
              var tagTypeSubscriptions = _k2[_j2]
              for (
                var _l = 0, _m = Object.values(tagTypeSubscriptions);
                _l < _m.length;
                _l++
              ) {
            ...
            for (
              var _o = 0, providedTags_1 = providedTags;
              _o < providedTags_1.length;
              _o++
            ) {
  ...
  var configSlice = createSlice({
    ...
    extraReducers: function (builder) {
      builder
        .addCase(onOnline, function (state) {
          state.online = true
        })
  ...
  var actions = __spreadProps(
    __spreadValues(
      __spreadValues(
        __spreadValues(
          __spreadValues(
            __spreadValues({}, configSlice.actions),
            querySlice.actions
          ),
...
function buildSelectors(_j) {
  ...
  function buildQuerySelector(endpointName, endpointDefinition) {
    return function (queryArgs) {
      ...
      var selectQuerySubstate = function (state) {
        ...
        return (_c =
          (_b =
            (_a = selectInternalState(state)) == null ? void 0 : _a.queries) ==
          null
            ? void 0
            : _b[serializedArgs]) != null
          ? _c
          : defaultQuerySubState
      }
      var finalSelectQuerySubState =
  ...
  function buildMutationSelector() {
    return function (id) {
      ...
      var selectMutationSubstate = function (state) {
        ...
        return (_c =
          (_b =
            (_a2 = selectInternalState(state)) == null
              ? void 0
              : _a2.mutations) == null
            ? void 0
            : _b[mutationId]) != null
      ...
      var finalSelectMutationSubstate =
  ...
  function selectInvalidatedBy(state, tags) {
    ...
    for (
      var _j2 = 0, _k = tags.map(expandTagDescription);
      _j2 < _k.length;
      _j2++
    ) {
      var tag = _k[_j2]
      ...
      var invalidateSubscriptions =
        (_a =
          ...
          : []
      for (
        var _l = 0, invalidateSubscriptions_1 = invalidateSubscriptions;
        _l < invalidateSubscriptions_1.length;
        _l++
      ) {
    ...
    return flatten(
      Array.from(toInvalidate.values()).map(function (queryCacheKey) {
...
function buildCreateApi() {
  ...
  return function baseCreateApi(options) {
    var extractRehydrationInfo = defaultMemoize(function (action) {
      var _a, _b
      return (_b = options.extractRehydrationInfo) == null
        ? void 0
        : _b.call(options, action, {
            reducerPath: (_a = options.reducerPath) != null ? _a : 'api',
          })
    })
    var optionsWithDefaults = __spreadProps(
      __spreadValues(
        {
          reducerPath: 'api',
            ...
            finalSerializeQueryArgs = function (queryArgsApi2) {
              ...
              if (typeof initialResult === 'string') {
                ...
                return defaultSerializeQueryArgs(
                  __spreadProps(__spreadValues({}, queryArgsApi2), {
    ...
    var api = {
      ...
      enhanceEndpoints: function (_j2) {
        var addTagTypes = _j2.addTagTypes,
          endpoints = _j2.endpoints
        if (addTagTypes) {
          for (
            var _k = 0, addTagTypes_1 = addTagTypes;
            _k < addTagTypes_1.length;
            _k++
          ) {
        ...
        if (endpoints) {
          for (
            var _l = 0, _m = Object.entries(endpoints);
            _l < _m.length;
            _l++
          ) {
            var _o = _m[_l],
    ...
    function injectEndpoints(inject) {
      ...
      for (
        var _j2 = 0, _k = Object.entries(evaluatedEndpoints);
        _j2 < _k.length;
        _j2++
      ) {
        var _l = _k[_j2],
        ...
        for (
          var _m = 0, initializedModules_1 = initializedModules;
          _m < initializedModules_1.length;
          _m++
        ) {
...
var buildCacheCollectionHandler = function (_j) {
  ...
  var handler = function (action, mwApi, internalState2) {
    ...
    if (unsubscribeQueryResult.match(action)) {
      ...
      handleUnsubscribe(
        queryCacheKey,
        (_a = state.queries[queryCacheKey]) == null ? void 0 : _a.endpointName,
        mwApi,
        state.config
      )
    }
    if (api.util.resetApiState.match(action)) {
      for (
        var _j2 = 0, _k2 = Object.entries(currentRemovalTimeouts);
        _j2 < _k2.length;
        _j2++
      ) {
        var _l = _k2[_j2],
    ...
    if (context.hasRehydrationInfo(action)) {
      ...
      for (var _m = 0, _o = Object.entries(queries); _m < _o.length; _m++) {
        ...
        handleUnsubscribe(
          queryCacheKey,
          queryState == null ? void 0 : queryState.endpointName,
          mwApi,
          state.config
        )
      }
  ...
  function handleUnsubscribe(queryCacheKey, endpointName, api2, config) {
    ...
    var finalKeepUnusedDataFor = Math.max(
      0,
...
var buildInvalidationByTagsHandler = function (_j) {
  ...
  var isThunkActionWithTags = isAnyOf(
  ...
  function invalidateTags(tags, mwApi) {
    ...
    context.batch(function () {
      ...
      for (
        var _j2 = 0, valuesArray_1 = valuesArray;
        _j2 < valuesArray_1.length;
        _j2++
      ) {
        var queryCacheKey = valuesArray_1[_j2].queryCacheKey
        var querySubState = state.queries[queryCacheKey]
        var subscriptionSubState =
          (_a = state.subscriptions[queryCacheKey]) != null ? _a : {}
        if (querySubState) {
...
var buildWindowEventHandler = function (_j) {
  ...
  function refetchValidQueries(api2, type) {
    ...
    context.batch(function () {
      for (
        var _j2 = 0, _k = Object.keys(subscriptions);
        _j2 < _k.length;
        _j2++
      ) {
        ...
        var shouldRefetch =
          Object.values(subscriptionSubState).some(function (sub) {
...
var buildCacheLifecycleHandler = function (_j) {
  ...
  var handler = function (action, mwApi, stateBefore) {
    ...
    if (queryThunk.pending.match(action)) {
      ...
      for (
        var _j2 = 0, _k = Object.entries(lifecycleMap);
        _j2 < _k.length;
        _j2++
      ) {
        var _l = _k[_j2],
  ...
  function handleNewKey(
    ...
    var endpointDefinition = context.endpointDefinitions[endpointName]
    var onCacheEntryAdded =
      endpointDefinition == null ? void 0 : endpointDefinition.onCacheEntryAdded
    ...
    var selector = api.endpoints[endpointName].select(
...
var buildQueryLifecycleHandler = function (_j) {
  ...
  var handler = function (action, mwApi) {
    ...
    if (isPendingThunk(action)) {
      var _j2 = action.meta,
        requestId = _j2.requestId,
        _k = _j2.arg,
        endpointName_1 = _k.endpointName,
        originalArgs_1 = _k.originalArgs
      var endpointDefinition = context.endpointDefinitions[endpointName_1]
      var onQueryStarted =
        endpointDefinition == null ? void 0 : endpointDefinition.onQueryStarted
      if (onQueryStarted) {
        var lifecycle_1 = {}
        ...
        var selector_1 = api.endpoints[endpointName_1].select(
          endpointDefinition.type === DefinitionType.query
            ? originalArgs_1
            : requestId
        )
      ...
      ;(_a = lifecycleMap[requestId]) == null
        ? void 0
        : _a.resolve({
            data: action.payload,
            meta: baseQueryMeta,
      ...
      ;(_c = lifecycleMap[requestId]) == null
        ? void 0
        : _c.reject({
  ...
  return function (action, mwApi) {
    ...
    if (typeof process !== 'undefined' && true) {
      if (
        ...
        ((_b =
          (_a = mwApi.getState()[reducerPath]) == null ? void 0 : _a.config) ==
        null
          ? void 0
          : _b.middlewareRegistered) === 'conflict'
      ) {
        console.warn(
...
var buildBatchedActionsHandler = function (_j) {
  ...
  var actuallyMutateSubscriptions = function (mutableState, action) {
    ...
    if (updateSubscriptionOptions.match(action)) {
      var _j2 = action.payload,
        queryCacheKey = _j2.queryCacheKey,
        requestId = _j2.requestId,
        options = _j2.options
      if (
        (_a = mutableState == null ? void 0 : mutableState[queryCacheKey]) ==
        null
          ? void 0
          : _a[requestId]
      ) {
    ...
    if (queryThunk.pending.match(action)) {
      ...
      if (arg.subscribe) {
        var substate =
          (_c = mutableState[(_b = arg.queryCacheKey)]) != null
            ? _c
            : (mutableState[_b] = {})
        substate[requestId] =
          (_e =
            (_d = arg.subscriptionOptions) != null
              ? _d
              : substate[requestId]) != null
            ? _e
            : {}
        return true
      }
    ...
    if (queryThunk.rejected.match(action)) {
      ...
      if (condition && arg.subscribe) {
        var substate =
          (_g = mutableState[(_f = arg.queryCacheKey)]) != null
            ? _g
            : (mutableState[_f] = {})
        substate[requestId] =
          (_i =
            (_h = arg.subscriptionOptions) != null
              ? _h
              : substate[requestId]) != null
            ? _i
            : {}
  ...
  return function (action, mwApi) {
    ...
    if (api.internalActions.internal_probeSubscription.match(action)) {
      var _j2 = action.payload,
        queryCacheKey = _j2.queryCacheKey,
        requestId = _j2.requestId
      var hasSubscription = !!((_a =
        internalState.currentSubscriptions[queryCacheKey]) == null
        ? void 0
        : _a[requestId])
      return [false, hasSubscription]
    }
    var didMutate = actuallyMutateSubscriptions(
    ...
    if (didMutate) {
      if (!dispatchQueued) {
        queueMicrotaskShim(function () {
          var newSubscriptions = JSON.parse(
            JSON.stringify(internalState.currentSubscriptions)
          )
      ...
      var isSubscriptionSliceAction = !!((_b = action.type) == null
        ? void 0
        : _b.startsWith(subscriptionsPrefix))
      var isAdditionalSubscriptionAction =
        queryThunk.rejected.match(action) &&
        action.meta.condition &&
        !!action.meta.arg.subscribe
      var actionShouldContinue =
      ...
      return function (action) {
        ...
        if (!!mwApi.getState()[reducerPath]) {
          ...
          if (
            ...
            for (
              var _k = 0, handlers_1 = handlers;
              _k < handlers_1.length;
              _k++
            ) {
    ...
    init: function (api, _j, context) {
      ...
      return {
        ...
        injectEndpoint: function (endpointName, definition) {
          var _a, _b
          var anyApi = api
          ;(_b = (_a = anyApi.endpoints)[endpointName]) != null
            ? _b
            : (_a[endpointName] = {})
...
function useStableQueryArgs(
  ...
  var incoming = (0, import_react2.useMemo)(
    function () {
      return {
        queryArgs,
        serialized:
...
function buildHooks(_c) {
  var api = _c.api,
    _d = _c.moduleOptions,
    batch = _d.batch,
    useDispatch2 = _d.useDispatch,
    useSelector2 = _d.useSelector,
    useStore2 = _d.useStore,
    unstable__sideEffectsInRender = _d.unstable__sideEffectsInRender,
    serializeQueryArgs = _c.serializeQueryArgs,
    context = _c.context
  var usePossiblyImmediateEffect = unstable__sideEffectsInRender
    ? function (cb) {
        return cb()
      }
    : import_react.useEffect
  ...
  function queryStatePreSelector(currentState, lastResult, queryArgs) {
    if (
      (lastResult == null ? void 0 : lastResult.endpointName) &&
    ...
    var data = currentState.isSuccess
      ? currentState.data
      : lastResult == null
      ? void 0
      : lastResult.data
      ...
      function (arg, options) {
        return dispatch(
          api.util.prefetch(
            endpointName,
            arg,
            __spreadValues2(__spreadValues2({}, stableDefaultOptions), options)
          )
        )
      },
  ...
  function buildQueryHooks(name) {
    var useQuerySubscription = function (arg, _c2) {
      var _d2 = _c2 === void 0 ? {} : _c2,
        refetchOnReconnect = _d2.refetchOnReconnect,
        refetchOnFocus = _d2.refetchOnFocus,
        refetchOnMountOrArgChange = _d2.refetchOnMountOrArgChange,
        _e = _d2.skip,
        skip = _e === void 0 ? false : _e,
        _f = _d2.pollingInterval,
        pollingInterval = _f === void 0 ? 0 : _f
      var initiate = api.endpoints[name].initiate
      var dispatch = useDispatch2()
      var stableArg = useStableQueryArgs(
        skip ? skipToken : arg,
      ...
      usePossiblyImmediateEffect(
        function () {
          ...
          var lastSubscriptionOptions =
            (_a = promiseRef.current) == null ? void 0 : _a.subscriptionOptions
          if (!lastPromise || lastPromise.arg !== stableArg) {
            lastPromise == null ? void 0 : lastPromise.unsubscribe()
            var promise2 = dispatch(
              initiate(stableArg, {
    ...
    var useLazyQuerySubscription = function (_c2) {
      var _d2 = _c2 === void 0 ? {} : _c2,
        refetchOnReconnect = _d2.refetchOnReconnect,
        refetchOnFocus = _d2.refetchOnFocus,
        _e = _d2.pollingInterval,
        pollingInterval = _e === void 0 ? 0 : _e
      var initiate = api.endpoints[name].initiate
      var dispatch = useDispatch2()
      var _f = (0, import_react.useState)(UNINITIALIZED_VALUE),
        arg = _f[0],
        setArg = _f[1]
      var promiseRef = (0, import_react.useRef)()
      var stableSubscriptionOptions = useShallowStableValue({
      ...
      usePossiblyImmediateEffect(
        function () {
          ...
          if (stableSubscriptionOptions !== lastSubscriptionOptions) {
            ;(_b = promiseRef.current) == null
              ? void 0
              : _b.updateSubscriptionOptions(stableSubscriptionOptions)
          }
        },
        [stableSubscriptionOptions]
      )
      var subscriptionOptionsRef = (0, import_react.useRef)(
        stableSubscriptionOptions
      )
      usePossiblyImmediateEffect(
        function () {
      ...
      var trigger = (0, import_react.useCallback)(
        function (arg2, preferCacheValue) {
          ...
          batch(function () {
            var _a
            ;(_a = promiseRef.current) == null ? void 0 : _a.unsubscribe()
            promiseRef.current = promise2 = dispatch(
              initiate(arg2, {
      ...
      ;(0, import_react.useEffect)(function () {
        return function () {
          var _a
          ;(_a = promiseRef == null ? void 0 : promiseRef.current) == null
            ? void 0
            : _a.unsubscribe()
        }
      }, [])
    ...
    var useQueryState = function (arg, _c2) {
      var _d2 = _c2 === void 0 ? {} : _c2,
        _e = _d2.skip,
        skip = _e === void 0 ? false : _e,
        selectFromResult = _d2.selectFromResult
      ...
      var selectDefaultResult = (0, import_react.useMemo)(
        function () {
      ...
      var querySelector = (0, import_react.useMemo)(
        function () {
      ...
      var store = useStore2()
      var newLastValue = selectDefaultResult(
        store.getState(),
        lastValue.current
      )
    ...
    return {
      ...
      useLazyQuery: function (options) {
        var _c2 = useLazyQuerySubscription(options),
          trigger = _c2[0],
          arg = _c2[1]
        var queryStateResults = useQueryState(
          arg,
          __spreadProps2(__spreadValues2({}, options), {
            skip: arg === UNINITIALIZED_VALUE,
          })
        )
        var info = (0, import_react.useMemo)(
          function () {
            return { lastArg: arg }
          },
          [arg]
      ...
      useQuery: function (arg, options) {
        ...
        var queryStateResults = useQueryState(
          ...
          __spreadValues2(
            {
              selectFromResult:
                arg === skipToken || (options == null ? void 0 : options.skip)
                  ? void 0
        ...
        return (0, import_react.useMemo)(
          function () {
            return __spreadValues2(
              __spreadValues2({}, queryStateResults),
  ...
  function buildMutationHook(name) {
    return function (_c2) {
      ...
      var triggerMutation = (0, import_react.useCallback)(
        function (arg) {
      ...
      var mutationSelector = (0, import_react.useMemo)(
        function () {
          return createSelector(
            [
              select({
                fixedCacheKey,
                requestId: promise2 == null ? void 0 : promise2.requestId,
              }),
            ],
            selectFromResult
          )
      ...
      var originalArgs =
        fixedCacheKey == null
          ? promise2 == null
            ? void 0
            : promise2.arg.originalArgs
          : void 0
      var reset = (0, import_react.useCallback)(
        function () {
          batch(function () {
            if (promise2) {
              setPromise(void 0)
      ...
      var finalState = (0, import_react.useMemo)(
        function () {
          return __spreadProps2(__spreadValues2({}, currentState), {
            originalArgs,
            reset,
...
var reactHooksModule = function (_c) {
  var _d = _c === void 0 ? {} : _c,
    _e = _d.batch,
    batch = _e === void 0 ? import_react_dom.unstable_batchedUpdates : _e,
    _f = _d.useDispatch,
    useDispatch2 = _f === void 0 ? useDispatch : _f,
    _g = _d.useSelector,
    useSelector2 = _g === void 0 ? useSelector : _g,
    _h = _d.useStore,
    useStore2 = _h === void 0 ? useStore : _h,
  ...
  return {
    ...
    init: function (api, _c2, context) {
      ...
      var _d2 = buildHooks({
        ...
        buildQueryHooks = _d2.buildQueryHooks,
        buildMutationHook = _d2.buildMutationHook,
        usePrefetch = _d2.usePrefetch
      safeAssign2(anyApi, { usePrefetch })
      safeAssign2(context, { batch })
      return {
        injectEndpoint: function (endpointName, definition) {
          if (isQueryDefinition2(definition)) {
            var _c3 = buildQueryHooks(endpointName),
              useQuery = _c3.useQuery,
              useLazyQuery = _c3.useLazyQuery,
              useLazyQuerySubscription = _c3.useLazyQuerySubscription,
              useQueryState = _c3.useQueryState,
              useQuerySubscription = _c3.useQuerySubscription
...
function ApiProvider(props) {
  ...
  ;(0, import_react4.useEffect)(
    function () {
      return props.setupListeners === false
        ? void 0
